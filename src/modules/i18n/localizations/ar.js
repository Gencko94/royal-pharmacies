export const ar = {
  ...
  'multiple-items': 'قطع',
  'cart-tos':
    'إن سعر وتوافر العناصر عرضة للتغيير. تعتبر عربة التسوق مكانًا مؤقتًا لتخزين قائمة بالعناصر الخاصة بك وتعكس أحدث سعر لكل عنصر.',
  ...
  'checkout-modal-tos':
    'يساعدنا امتلاكك لحساب  على تقديم افضل الخدمات لك ولعملائنا الآخرين .',
  ...
  offers: 'العروض',
  'no-offers': 'لا توجد عروض حاليا لهذه الفئة :(',
  'comeback-later': 'قم بزيارة هذه الصفحة لاحقا لمتابعة اخر العروض',
  'go-to-products': 'اكتشف منتجاتنا من هذه الفئة',
  'download-apps': 'حمل تطبيقاتنا على جوالك ',
};
