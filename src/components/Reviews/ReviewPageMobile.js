...
export default function ReviewPageMobile({ product, handleCloseReviewPage }) {
  ...
  return (
    ...
    >
      ...
      <div className=" sticky top-0 p-3 flex items-center bg-main-color text-main-text z-1">
        ...
        <h1 className="font-semibold text-lg mx-4 text-clamp-2">
      ...
      <div className="p-2">
        <div className="">
          ...
          <Rating
            emptySymbol={<AiOutlineStar className="text-main-color w-6 h-6" />}
            fullSymbol={<AiFillStar className="text-main-color w-6 h-6" />}
            className="pt-1 mx-2"
        ...
        <div className="flex justify-end">
          <button
            ...
            className={`p-2 uppercase text-sm font-semibold rounded ${
              !feedback
