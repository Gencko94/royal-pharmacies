...
export default function ViewedItemMobile({
  item,
  removeButtonLoading,
  handleRemoveItem,
}) {
  ...
  return (
    ...
    >
      ...
      <div className="pt-2">
        ...
        >
          <h1 className=" text-sm font-semibold text-clamp-2 ">{item.name}</h1>
        </Link>
        <Rating
        ...
        <button
          ...
          } px-2 py-1 rounded-sm flex items-center justify-center`}
          style={{ width: '76px' }}
        >
          {removeButtonLoading === item.id ? (
